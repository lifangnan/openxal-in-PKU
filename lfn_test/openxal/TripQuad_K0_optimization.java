...
public class TripQuad_K0_optimization {
...
//		1. 加载加速器配置
		...
		String table_name = "G_K_optimization";
...
//			sql = String.format("UPDATE bayes_optimization SET sigmaX=%f, sigmaY=%f, finished=%d WHERE id=%d", sigma[0], sigma[1], 1, rs.getInt("id"));
			sql = String.format("INSERT INTO %s(G1, G2, G3, K0, sigmaX, sigmaY, finished) VALUES(%f, %f, %f, %f, %f, %f, %d)", table_name, G1, G2, G3, K0, sigma[0], sigma[1], 1);
