...
public class TripQuad_optimization {
...
//			sql = String.format("UPDATE bayes_optimization SET sigmaX=%f, sigmaY=%f, finished=%d WHERE id=%d", sigma[0], sigma[1], 1, rs.getInt("id"));
			sql = String.format("INSERT INTO bayes_optimization_G(G1, G2, G3, sigmaX, sigmaY, finished) VALUES(%f, %f, %f, %f, %f, %d)", G1, G2, G3, sigma[0], sigma[1], 1);
